   ...
   <view>
        <view class="video_tab">
            ...
            <view class="video_tab_content">
                ...
                <view v-if="current < 4">
                    <video-main :videoInfo="{url: items[current].url, params: items[current].params}"></video-main>
                </view>
                <view v-if="current === 4">
                    <video-category :videoInfo="{url: items[current].url}"></video-category>
                </view>
...
import videoCategory from "./video_category/index"
export default {
    components: {
        uniSegmentedControl,
        videoMain,
